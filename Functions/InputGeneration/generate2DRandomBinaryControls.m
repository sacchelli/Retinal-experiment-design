function [controls, inputParameters] = generate2DRandomBinaryControls(sdn, N, K, seed)
% GENERATE2DRANDOMCONTROLS Creates random control inputs for retinal experiments
%
% Inputs:
...
for i = 1:K
    ...
    control_temp = minValue + (maxValue - minValue) * (rand(sdn^2, N)>1/2);
